<p align="center">
  <picture>
    ...
    <img src="light.svg" alt="Suyash Madke — Data Science, Python, Applied ML and Analytics" width="100%">
  </picture>
</p>
...
> **Data Science student · Python developer · Applied ML / AI**
>
> I build practical Python applications and applied ML systems, with a growing
> focus on data analytics. My strongest work spans federated learning, learning
> tools, AI-assisted productivity, and practical finance applications.

```text
ROLE      = Data Science Student | Python Developer
DOMAIN    = Data Science | Machine Learning | Applied AI
TOOLKIT   = Python | SQL | Pandas | NumPy | scikit-learn
FOCUS     = Analytics | Applied ML | Federated Learning
...
```text
01  APPLIED ML
    Models, baselines, evaluation and practical ML systems.

02  FEDERATED LEARNING
    FedAvg and privacy-preserving credit-risk experimentation.

03  PYTHON APPLICATIONS
    Streamlit, FastAPI, CLI and local-first tools.

04  DATA ANALYTICS
    SQL, Excel, Tableau-oriented analysis and visualization.

05  APPLIED AI
    Multi-provider LLM integration and AI-assisted applications.
```
...
`Python` `SQL` `Pandas` `NumPy` `scikit-learn` `TensorFlow` `Tableau`

**Applications & Data**

`FastAPI` `Streamlit` `SQLite` `LLM APIs`
...
<details open>
<summary><strong>01 · Federated Learning</strong></summary>

Current focus on FedAvg, IID/Non-IID simulation and privacy-preserving credit-risk modeling.
...
SQL, Excel/Tableau-oriented analytics, data preparation and visualization.

</details>

<details>
<summary><strong>03 · Python Development</strong></summary>

CLI tools, Streamlit applications, FastAPI services and application logic.

</details>

<details>
<summary><strong>04 · Applied AI</strong></summary>
...
**Evidence:** ~**76.5%** federated accuracy after 15 rounds, compared with **78.2%** for the strongest centralized baseline.

`Python` `TensorFlow` `scikit-learn` · Final-year project · Two-person team

[View repository →](https://github.com/Samuel-025/federated-credit-risk-assessment)
...
Local-first app + CLI for saving YouTube videos, generating summaries and tracking learning progress. Includes AI flashcards and exports to Notion/Obsidian/Anki.
...
[Repository →](https://github.com/Samuel-025/daily_ai_assistant) · [Live demo →](https://dailyaiassistant-bfszw6tsvquoaav2acjhuo.streamlit.app/)
...
FastAPI + SQLite backend with a multi-currency web dashboard and PDF/Excel report export.

`Python` `FastAPI` `SQLite`

[Repository →](https://github.com/Samuel-025/Personal-FinanceTracker) · [Live demo →](https://samuel-025.github.io/Personal-FinanceTracker/)
...
<details open>
<summary><strong>~76.5% federated accuracy</strong></summary>

Achieved after 15 FedAvg communication rounds, compared with a 78.2% strongest centralized baseline.

</details>

<details>
<summary><strong>233 tests passing</strong></summary>

Verified test-suite result for YouTube Learning Tracker.

</details>

<details>
<summary><strong>4 featured projects</strong></summary>

Federated Credit Risk Assessment · YouTube Learning Tracker · Daily AI Assistant · Personal Finance Tracker.

</details>

<details>
<summary><strong>16 public repositories</strong></summary>

Current public repository inventory on the GitHub account.
...
Focus areas include **Python, SQL, Excel, Tableau, data analysis & visualization, Machine Learning, AI, Pandas, NumPy, Matplotlib and web fundamentals.**

### `$ technical-focus`

> These are self-described working areas, not independently certified skill levels.

- **Python Development** — CLI tools, Streamlit apps, APIs, automation and application logic.
- **Data Science** — data preparation, EDA, visualization and model evaluation.
- **Machine Learning** — scikit-learn workflows, baselines, evaluation and applied modeling.
- **Federated Learning** — FedAvg, IID/Non-IID simulation and privacy-preserving credit-risk modeling.
- **Data Analytics** — SQL, Excel/Tableau-oriented analytics and visualization.
- **Applied AI / LLMs** — multi-provider LLM integration and AI-assisted applications.

### `$ github-proof`

<p align="center">
  <a href="https://github.com/Samuel-025"><img src="https://github-profile-trophy.vercel.app/?username=Samuel-025&theme=darkhub&no-frame=true&no-bg=true&margin-w=6&row=1&column=6" alt="GitHub trophies" width="100%"></a>
</p>
...
EXPLORING → Privacy-preserving ML · data analytics
```
